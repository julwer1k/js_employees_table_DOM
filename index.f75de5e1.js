...
function addRowToTable(e) {
    ...
    const [isValid, errorInput] = checkValidateForm(nameValue, ageValue, salaryValue);
    ...
    } else pushNotification(600, 450, `It is impossible to add: Error in the ${errorInput} field`, errorInput, "error");
}
